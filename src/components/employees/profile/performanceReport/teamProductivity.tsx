...
const TeamProductivity = ({ monthlyTeamBilllingSummary }: any) => {
  ...
  useEffect(() => {
    ...
    for (let i = 11; i >= 0; i--) {
      ...
      const summary = monthlyTeamBilllingSummary.find((entry: { year: any; month: any; }) => entry.year === year && entry.month === month);
